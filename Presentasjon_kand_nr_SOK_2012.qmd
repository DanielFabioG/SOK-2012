...
::: {.column width="50%"}
Hendelsen at <span style="color: #3fb618;">gevinsten</span> (150 kr) er i konvolutt $i$ (hvor $i$ kan være 1, 2, eller 3).

Hendelsen at <span style="color: #2780e3;">deltakeren</span> velger konvolutt $j$ (hvor $j$ også kan være 1, 2, eller 3).

Hendelsen at <span style="color: #e83e8c;">verten</span> åpner konvolutt $k$ (hvor $k$ kan være 1, 2, eller 3) og viser at den er tom.
:::
:::
...
::: {.column width="50%"}
Dette betyr at hendelsene <span style="color: #3fb618;">$G_i$</span> eller <span style="color: #3fb618;">gevinsten</span> er i konvolutt $i$  og <span style="color: #2780e3;"> $D_j$</span>, <span style="color: #2780e3;">deltakerens</span> valg $j$ er uavhengige for alle $i$ og $j$.

<span style="color: #3fb618;">$P(G_i)$</span> $=$ <span style="color: #2780e3;"> $P(D_j)$</span> $=$ <span style="color: #e83e8c;"> $p(V_k)$</span> $= \frac{1}{3}$ 
...
Men kan forkortes slik, siden den totale sannsynligheten for $B$ er lik summen av sannsynligheten for $B$ gitt $A$ og sannsynligheten for $B$ gitt ikke $A$.
:::
